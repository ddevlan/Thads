...
import me.ohvalsgod.thads.mysterychest.loot.MysteryChestLootEdit;
...
public class MysteryChest {
    ...
    private List<MysteryChestLoot> loot;   //TODO: add logs
    private Map<UUID, Set<MysteryChestLootEdit>> lootEditMap;

    public MysteryChest(String name) {
        this.name = name;
        color = ChatColor.RED;
        loot = new ArrayList<>();
        lootEditMap = new HashMap<>();
