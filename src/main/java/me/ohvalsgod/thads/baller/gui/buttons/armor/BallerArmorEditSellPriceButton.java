...
@AllArgsConstructor
public class BallerArmorEditSellPriceButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        ...
        builder.name(Thads.getInstance().getLang().getString("lol.menu.armor.edit.price.sell"));
    ...
    public void clicked(Player player, int slot, ClickType clickType, int hotbarButton) {
        if (!BallerArmorEditBuyPriceButton.getInEdit().containsKey(player.getUniqueId())
