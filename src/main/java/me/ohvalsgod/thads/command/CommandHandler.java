...
public final class CommandHandler implements Listener {
     ...
     * This can only be called once, and is called automatically when Thads enables.
     */
     ...
     * @param packageName The package to load commands from. Example: "me.ohvalsgod.game.commands"
     */
    ...
    /**
     * @return the full command line input of a player before running or tab completing a Thads command
     */
     ...
     * Use this instead of Player#performCommand as that method does not call a PlayerCommandPreprocess event.
     *
